...
',
    ...
    'LBL_SORT_MODULES' => 'Отсортировать модули по алфавиту',
    'LBL_SORT_MODULES_DESCRIPTION' => 'Упорядочить модули по имени в ниспадающем меню.',
    'LBL_COUNT_COLLAPSED_SUBPANELS' => 'Показать совет по свернутой субпанели',
    'LBL_COUNT_COLLAPSED_SUBPANELS_DESCRIPTION' => 'Если вложенные панели свернуты, отображается подсказка, указывающая, является ли вложенная панель пустой или содержит записи.',
...
<table cellpadding=0 cellspacing=0> <tr><td><!--not_in_theme!-->Посетите www.suitecrm.com <img src=include/images/suitecrm_login.png style="margin-right: 5px;"> </td><td><a href="http://www.suitecrm.com/" target="_blank"><b>SuiteCRM</b></a></td></tr></table>',
    ...
    'LBL_QUICK_LEAD' => 'Создать предв. контакт',
    'LBL_QUICK_DOCUMENT' => 'Создать документ',
    'LBL_QUICK_CALL' => 'Запланировать звонок',
    ...
    'LBL_GOOGLE_API_TOKEN_DISABLED' => 'Выкл.', // PR 6841
    'LBL_GOOGLE_API_TOKEN_INVALID' => 'Invalid Auth Key', // PR 6841
    'LBL_GOOGLE_API_TOKEN_BTN_DISABLED' => 'Выкл.', // PR 6841
