...
$mod_strings = array(
    ...
    'NEW_LOGO_HELP_NO_SPACE' => 'Допустимы следующие форматы изображений: PNG или JPG. Максимальная высота изображения - 170px, максимальная ширина - 450px. Любое загруженное изображение, размер которого будет превышать указанные значения, будет масштабировано до допустимых размеров.',
    ...
    'SUITEPDF_BASIC_SETTINGS' => 'Свойства документа',
    'SUITEPDF_ADVANCED_SETTINGS' => 'Расширенные настройки',
    'SUITEPDF_LOGO_SETTINGS' => 'Логотипы',
    ...
    'PDF_NEW_HEADER_LOGO_INFO' => 'Формат файла может быть .jpg или .png. (Только .jpg для EZPDF)<br />Рекомендованный размер: 867x60 px.',
