...
//ABOUT page
    ...
    'LBL_DASHLET_DISCOVER_SUITE' => 'Узнать о SuiteCRM',
    ...
    'LBL_MINSS_ABBREV' => ' минут(ы) ',
    'LBL_LOCATION' => 'Место:',
    'LBL_STATUS' => 'Статус:',
    'LBL_DESCRIPTION' => 'Описание: ',
    //End Events

    'LBL_ELASTIC_SEARCH_EXCEPTION_SEARCH_INVALID_REQUEST' => 'Во время выполнения поиска произошла ошибка. Синтаксис запроса может быть недопустимым.',
